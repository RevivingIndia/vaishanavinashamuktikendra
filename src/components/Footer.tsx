...
import { CONTACT_PHONE, CONTACT_PHONE_RAW, CONTACT_ADDRESS, SOCIAL_LINKS } from '../utils/constants'
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <Link to="/" className="inline-block mb-4">
              <img src="/logo.jpg" alt="Vaishanavi Nasha Mukti Kendra" className="h-16 w-auto max-h-20 object-contain opacity-95 hover:opacity-100 transition-opacity" />
            </Link>
            ...
            <div className="flex items-center gap-3 mb-4">
              {socialIcons.map(({ label, href, icon }) => (
                <a
                  ...
                  className="p-2 rounded-lg text-slate-400 hover:text-teal-400 hover:bg-slate-700/50 transition-colors"
                  aria-label={label}
                >
